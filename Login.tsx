...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      // Simulasi Google OAuth login
      // Dalam implementasi nyata, gunakan Google OAuth SDK
      const googleUser = {
      ...
      const success = await login(googleUser.email, 'google-oauth');
      ...
      <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
        ...
        <GlassCard className="w-full max-w-md relative animate-slide-up">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold">Masuk ke QRISPay</h1>
